...
class GAT(torch.nn.Module):
    def __init__(self, dataset):
      ...
      self.conv1 = GATConv(num_features, hidden_channel1, heads=num_heads, bias=False)
      self.conv2 = GATConv(hidden_channel1*num_heads, hidden_channel2, heads=num_heads, bias=False)
      self.conv3 = GATConv(hidden_channel2*num_heads, num_classes, heads=num_heads, bias=False)
